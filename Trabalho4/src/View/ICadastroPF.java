...
public class ICadastroPF extends JFrame implements ActionListener {
	...
	public ICadastroPF(DAOClientes cliente) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (comando.equals("Cadastrar")) {
			...
			try {
				if (cliente.validaDigitoCpf(cpf) == true) {
					cpf = ffieldCpf.getText();
				} else {
			...
			cliente.incluirClientePF(nome, renda, endereco, bairro, cep, cidade, uf, telefone, situacao, sexo, rg, cpf);
